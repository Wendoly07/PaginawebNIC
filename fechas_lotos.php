...
try {
    ...
    $stmt = $conn->query("SELECT * FROM paginaweb_nic_fechas_loto WHERE id = 1");
    $config = $stmt->fetch(PDO::FETCH_ASSOC) ?: [];
} catch (PDOException $e) {
    $config = [];
}

$logoUrl = !empty($config['logo']) ? $config['logo'] : '/ImagesSV/LOGO FECHAS LOTOS.png.png';
?>
<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
  <title>Fechas Lotos</title>
  ...
  <style>
    ...
    * {
    ...
    .menu a {
      background: linear-gradient(135deg, #a01c1f, #e30613);
      color: white;
    ...
    .calendario-real td.activo {
      background: linear-gradient(135deg, #e30613, #eb1619);
      color: white;
      border-radius: 50%;
      font-weight: bold;
...
<body>
  ...
  <div class="top">
    <div class="top-content"> 
      <img src="<?= htmlspecialchars($logoUrl) ?>" alt="Logo Fechas Lotos">
      ...
      <div class="ganador-box">
        ...
        <div class="nums">
          ...
          <span class="num-mes" id="numMes">---</span>
        </div>
