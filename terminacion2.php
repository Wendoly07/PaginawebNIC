...
try {
    ...
    $stmt = $conn->prepare("SELECT * FROM paginaweb_nic_terminacion2 WHERE id = ?");
    $stmt->execute([1]);
...
$logoUrl = !empty($config['logo']) ? $config['logo'] : '/ImagesSV/logo terminacion2.png';
?>
<!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="UTF-8">
  <title>Terminación 2</title>
...
<body>
  ...
  <div class="top">
    <div class="top-content"> 
      <img src="<?= htmlspecialchars($logoUrl) ?>" alt="Logo Terminacion2">
  ...
  <div class="reglamento">
    <a href="/ImagesSV/documentos/Reglamento Terminacion2.pdf" target="_blank">
